...
public class HomeFrame extends JFrame {
    ...
    public HomeFrame() {
        ...
        btnConsultaParticipantes.addActionListener(e -> {
            // new ConsultaParticipanteFrame().setVisible(true); // Se o construtor não tornar visível
        ...
        // --- RODAPÉ ---
        JLabel footerLabel = new JLabel("© 2025 Sistema de Eventos Pro", SwingConstants.CENTER);
