  ...
  private void abrirJanelaEdicao() {
    ...
    if (linhaSelecionada >= 0) {
      ...
      if (modelRow < eventos.size()) { // Verifica se o índice está dentro dos limites da lista 'eventos'
        ...
        JOptionPane.showMessageDialog(this, "Erro ao selecionar o evento. Tente novamente.", "Erro de Seleção",
            JOptionPane.ERROR_MESSAGE);
      }
    } else {
      JOptionPane.showMessageDialog(this, "Por favor, selecione um evento na tabela para editar.",
      ...
      if (confirm == JOptionPane.YES_OPTION) {
        ...
        if (modelRow < eventos.size()) {
          ...
          if ("sucesso".equalsIgnoreCase(resultado)) {
            ...
            JOptionPane.showMessageDialog(this, "Erro ao excluir o evento: " + resultado, "Erro na Exclusão",
                JOptionPane.ERROR_MESSAGE);
          }
        } else {
          System.err.println("Erro: Índice de linha selecionada fora dos limites da lista de eventos para exclusão.");
          JOptionPane.showMessageDialog(this, "Erro ao selecionar o evento para excluir. Tente novamente.",
              "Erro de Seleção", JOptionPane.ERROR_MESSAGE);
        }
      }
    } else {
      JOptionPane.showMessageDialog(this, "Selecione um evento na tabela para excluir.", "Nenhum Evento Selecionado",
          JOptionPane.INFORMATION_MESSAGE);
    }
  }
    ...
    if (linhaSelecionada >= 0) {
      try {
        ...
        if (modelRow < eventos.size()) {
          ...
          System.err.println(
              "Erro: Índice de linha selecionada fora dos limites da lista de eventos para ver participantes.");
          JOptionPane.showMessageDialog(this, "Erro ao selecionar o evento. Tente novamente.", "Erro de Seleção",
              JOptionPane.ERROR_MESSAGE);
        }
      } catch (IndexOutOfBoundsException e) { // Segurança adicional, embora a checagem acima deva cobrir
        JOptionPane.showMessageDialog(this, "Erro ao obter dados do evento selecionado.", "Erro Interno",
            JOptionPane.ERROR_MESSAGE);
      }
    } else {
      JOptionPane.showMessageDialog(this, "Por favor, selecione um evento na tabela.", "Nenhum Evento Selecionado",
          JOptionPane.INFORMATION_MESSAGE);
    }
  }
}